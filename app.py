...
st.set_page_config(page_title="Caderno Didático: GPT", layout="wide", initial_sidebar_state="collapsed")
...
""", unsafe_allow_html=True)
    ...
    st.markdown('<p style="text-align:center; font-size:1.1rem;">🔊 Trilha Sonora do Dossiê:</p>', unsafe_allow_html=True)
    st.audio("audio_lado_b.mp3")

    st.markdown('<h2 style="border-bottom: 2px solid #b32424; padding-bottom:10px; margin-top:2rem;">Capítulo 1: O Portão</h2>', unsafe_allow_html=True)
...
<style>
    ...
    .legenda-img {{ font-size: 0.95rem !important; color: #777 !important; text-align: center !important; font-style: italic !important; margin-bottom: 3rem !important; font-family: 'Lora', serif !important; margin-top: 0.5rem !important; }}
...
""", unsafe_allow_html=True)
    ...
    st.markdown('<p style="text-align:center; font-size:1.1rem;">🔊 Trilha Sonora Poética:</p>', unsafe_allow_html=True)
    st.audio("audio_lado_a.mp3")
